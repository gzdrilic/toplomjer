...
var checkbox_select = function(params)
{
    ...
    var that            = this,
        ...
        selected_translation    = params.selected_translation   ? params.selected_translation   : "",
        ...
        $_submit        = $("<input />")    .addClass("checkbox_select_submit")     .val("Gotovo") .attr('type','submit') .data("selected", ""),
